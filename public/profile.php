...
<body class="bg-[#F5F5F8] p-5">
    <div class="flex items-center justify-around mb-5 mt-3">
        <div class="w-28">
            <img class="w-full h-full rounded-full" src="/img/profil-dummy.png" alt="">
        </div>
        <div>
            <h1 class="text-main-color font-semibold pb-1 border-b border-gray-500">Camelia Levato</h1>
            <p class="text-xs mt-1">camelia@gmail.com</p>
        </div>
        <img class="w-4" src="/icon/pen-solid.svg" alt="">
    </div>

    <div class="mb-6">
        <h1 class="font-bold text-xl mb-1">Account</h1>
        <div class="">
            <button class="flex rounded-full w-full bg-main-color bg-opacity-10 mb-2 p-2 drop-shadow-lg">
                <p class="font-semibold text-left pl-4">Saved Address</p>
                <img class="ml-auto mt-1" src="/icon/chevron-left.svg" alt="">
            </button>
            <button class="flex rounded-full w-full bg-main-color bg-opacity-10 mb-2 p-2 drop-shadow-lg">
                <p class="font-semibold text-left pl-4">Payment Methods</p>
                <img class="ml-auto mt-1" src="/icon/chevron-left.svg" alt="">
            </button>
            <button class="flex rounded-full w-full bg-main-color bg-opacity-10 mb-2 p-2 drop-shadow-lg">
                <p class="font-semibold text-left pl-4">Change Password</p>
                <img class="ml-auto mt-1" src="/icon/chevron-left.svg" alt="">
            </button>
        </div>
    </div>
    ...
    <div>
        <h1 class="font-bold text-xl mb-1">General</h1>
        <div class="">
            <button class="flex rounded-full w-full bg-main-color bg-opacity-10 mb-2 p-2 drop-shadow-lg">
                <p class="font-semibold text-left pl-4">Help & Contact Us</p>
                <img class="ml-auto mt-1" src="/icon/chevron-left.svg" alt="">
            </button>
            <button class="flex rounded-full w-full bg-main-color bg-opacity-10 mb-2 p-2 drop-shadow-lg">
    ...
    <div class="bg-main-color fixed bottom-0 left-0 right-0 p-4 flex justify-between">
        ...
        <a class="bg-white p-3 rounded-full" href="">
            <svg class="w-5 drop-shadow-lg"v xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path class="fill-main-color" d="M272 304h-96C78.8 304 0 382.8 0 480c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32C448 382.8 369.2 304 272 304zM48.99 464C56.89 400.9 110.8 352 176 352h96c65.16 0 119.1 48.95 127 112H48.99zM224 256c70.69 0 128-57.31 128-128c0-70.69-57.31-128-128-128S96 57.31 96 128C96 198.7 153.3 256 224 256zM224 48c44.11 0 80 35.89 80 80c0 44.11-35.89 80-80 80S144 172.1 144 128C144 83.89 179.9 48 224 48z"/>
            </svg>
        </a>
    </div>
</body>
