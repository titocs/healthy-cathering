...
<body class="bg-[#F5F5F8] relative overflow-scroll">
    <div class="w-full h-20 bg-[url('./img/food/tes.png')]">
        <button class="bg-white rounded-full" onclick="history.back()">
    ...
    <div class="p-5">
        ...
        <div class="">
            <div class="w-5 h-w-5">
                <img class="w-full h-full" src="/img/food/tes.png" alt="">
            </div>
            <div>
                <div>
                    <h2>Nature Food</h2>
                    <p>$$$<span>$</span>.Western</p>
                </div>
                <p>1,2 km. Delivery in 15 minutes</p>
            </div>
            <div>
                <img src="" alt="">
                <p></p>
