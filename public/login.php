...
=======
            <input class="w-full bg-transparent placeholder:text-main-color focus:outline-none" name="username" type="text" placeholder="Email" autocomplete="off">
>>>>>>> ee957bafb6395451279f678b4aa248e713034be6:public/login.html
        </div>
