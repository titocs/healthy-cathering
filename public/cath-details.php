...
<head>
    ...
    <title>Cathering Details</title>
</head>
<body class="bg-[#F5F5F8]">
    <div>
        <!-- Cathering Profile -->
        <div class="bg-main-color bg-opacity-80 rounded-b-3xl w-full">
            <div class="p-5">
                <button onclick="history.back()">
                    <img class="w-3" src="/icon/angle-left-solid.svg" alt="">
                </button>
                <section class="p-2 pl-5">
                    <div class="bg-[url('/img/vegetable.png')] bg-cover w-full h-40 rounded-lg relative overflow-hidden inline-block">
                        <img>
                    </div>
                </section>

                <section class="flex mb-2">
                    <h1 class="font-semibold text-3xl text-white pl-5">Westiees</h1>
                    <h3 class="flex items-center ml-auto gap-1 text-white pr-4">
                        <img class="w-6" src="/icon/star.svg" alt="">
                        4.9
                    </h3>
                </section>

                <section class="flex pl-5 gap-10">
                    <section class="flex flex-col">
                        <h4 class="flex items-center text-xs text-white gap-1 mb-1">
                            <img class="w-4" src="/icon/pin-location.svg" alt="">
                            1,57 km
                        </h4>
    
                        <h3 class="text-white text-sm">
                            Jl. Ijo-ijo Sehat, Kemang, Jakarta Selatan
                        </h3>
                    </section>

                    <section class="flex flex-col font-light text-xs text-white">
                        <h3 class="text-center mt-1">$$$$</h3>
                        <h3 class="mt-1 mb-1">55k-105k</h3>
                    </section>
                </section>
            </div>
        </div>
        ...
        <!-- This Week Package -->
        <div class="p-5 pb-0 mb-28">
            <a href="/public/pckg-detail.php">
                <h1 class="font-semibold text-lg py-1">This Week Package</h1>
                <div class="flex gap-5 items-center bg-main-color bg-opacity-30 drop-shadow-lg rounded-md mb-5">
                    <section class="p-2 m-2 pl-5">
                        <div class="bg-[url('/img/dietplan.png')] bg-cover w-20 h-20 rounded-md relative overflow-hidden inline-block">
                        </div>
                    </section>
            
                    <section class="flex flex-col h-24">
                        <h2 class="font-semibold text-md my-2 border-b-2 border-gray-700">Korean Cuisine</h2>
                        <h3 class="font-light text-xs mt-1">$$$$</h3>
                        <h3 class="font-light text-xs mt-1 mb-1">55k - 105k</h3>
                    </section>
                </div>
            </a>
        </div>
