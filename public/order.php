...
<body class="bg-[#F5F5F8] p-5">
    <h1 class="text-3xl font-bold mb-5">Your Orders</h1>
    <div class="flex items-center justify-evenly bg-white drop-shadow-lg rounded-md mb-5">
        <section class="p-2">
            <div class="bg-[url('/img/dietplan.png')] bg-cover w-14 h-14 rounded-md relative overflow-hidden inline-block">
                <img>
            </div>
        </section>

        <section class="flex flex-col">
            <h2 class="font-semibold text-sm mt-1">Korean Cuisine</h2>
            <h3 class="font-light text-xs mt-1">1 Month Package | Lunch Dinner</h3>
            <h3 class="font-light text-xs mt-1 mb-1">1 Nov - 31 Nov 2021</h3>
        </section>

        <section class="flex flex-col justify-around">
            <h2 class="font-semibold text-sm">Rp2500K</h2>
            <h2 class="bg-main-color rounded-full text-xs text-center text-white mt-1 p-1">Ongoing</h2>
        </section>
    </div>
    ...
    <div class="bg-main-color fixed bottom-0 left-0 right-0 p-4 flex justify-between">
        ...
        <a class="p-3 rounded-full" href="/public/myplan.php">
            <svg class="w-5 drop-shadow-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
